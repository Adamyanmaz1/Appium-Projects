...
public class IOSTest extends BaseTest1 {
    public static void main(String[] args) throws MalformedURLException {
// TODO Auto-generated method stub

        IOSDriver<IOSElement>driver=capabilities();

        System.out.println(driver.findElementsByXPath("//XCUIElementTypeStaticText").size());

        List<IOSElement> Listofelement=driver.findElementsByXPath("//XCUIElementTypeStaticText");
